...
<div class="login-container">
    ...
    <div class="login-content">
    	<form method="post" accept-charset="utf-8" class="form-signin rwdvalid" id="admin_log" novalidate="novalidate" action="sys_posts.php">
			...
			<div class="form-group">
				...
				<input type="email" name="ad_email" id="ad_email" class="form-control required email" placeholder="Email address" maxlength="75">
			</div>
			<div class="form-group">
				<label for="ad_pword"> Password </label>
				<input type="password" name="ad_pword" id="ad_pword" class="form-control required" placeholder="Password">
			</div>

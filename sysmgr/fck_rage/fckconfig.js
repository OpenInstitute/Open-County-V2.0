...
FCKConfig.ForcePasteAsPlainText	= false ; //rage_change
...
FCKConfig.ToolbarSets["Basic"] = [
	['Source','-','FontFormat','Bold','Italic','Underline','TextColor','-','OrderedList','UnorderedList','-','JustifyLeft','JustifyCenter','-','Link','Unlink','Image','-','RemoveFormat']
] ;	// '-','PasteText','PasteWord',  //'JustifyRight', 'Table', ,'-','About'

FCKConfig.ToolbarSets["Murage"] = [
	['Source','-','Bold','Italic','-','PasteText','PasteWord','-','Link','Unlink','-','Image','-','About']
] ;
...
FCKConfig.FontFormats	= 'p;address;h1;h2;h3;h4;h5;h6' ;//div;pre;
...
FCKConfig.FirefoxSpellChecker	= true ;	//rage-change

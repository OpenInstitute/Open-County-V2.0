...
if($dir == 'sectors') {
	$fVars['tb_name']  = 'oc_app_sector';
	$fVars['tb_key']   = 'sector_id';
	
	$c_title = array('sector_id', 'title', 'description', 'published');	
	$c_label = array('sector_id', 'title', 'description', 'published');
	$c_cols  = array_combine($c_title, $c_label);
	$fVars['tb_cols']   = implode($c_title, ', ');
...
<form class="rwdform rwdfull rwdstripes" name="fm_vds" id="fm_vds" method="post" action="adm_posts.php">

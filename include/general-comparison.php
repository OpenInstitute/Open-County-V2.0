	<div class="col_full marg20_b">
			<h4><a href="#"><i class="icon-bar-chart"></i></a> &nbsp; GENERAL COMPARISON</h4>
		</div>
	<div class="col_one_thirdX col-md-3">
			<h5>Indicators</h5>
<?php
$compIndicatorList = $dispOc->get_comparisonIndicator($com_active, $ind);	
$compIndiCurrId    = ($ind == '') ? $compIndicatorList['indi_curr_id'] : $ind;			
$compIndiCurr    = $compIndicatorList['indi_curr'];		
$compIndiList    = $compIndicatorList['indi_list'];
$jsonIndiTitles	  = $compIndicatorList['indi_title'];		
		
$compIndicatorData = $dispOc->get_comparisonIndicatorData($compIndiCurrId);	//displayArray($compIndicatorList);	
$jsonCompareCounties = $compIndicatorData['county'];
$jsonCompareValues   = $compIndicatorData['values'];	
...
?>
	...
	<div class="col_two_thirdX col_lastX col-md-9">

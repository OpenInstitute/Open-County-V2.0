	...
	function paginate()
	{
		...
		if($this->num_pages > 10)
		{
			...
			for($i=1;$i<=$this->num_pages;$i++)
			{
				...
				{
					$this->return .= ($i == $this->current_page And @$_GET['page'] != 'All') ? "<a title=\"Go to page $i of $this->num_pages\" class=\"current\" href=\"#\">$i</a> ":"<a class=\"paginate\" title=\"Go to page $i of $this->num_pages\" href=\"".RDR_REF_PATH."?page=$i$this->querystring\">$i</a> ";	//&ipp=$this->items_per_page
				}
		...
		else
		{
			for($i=1;$i<=$this->num_pages;$i++)
			{
				$this->return .= ($i == $this->current_page) ? "<a class=\"current\" href=\"#\">$i</a> ":"<a class=\"paginate\" href=\"".RDR_REF_PATH."?page=$i$this->querystring\">$i</a> "; 	//&ipp=$this->items_per_page
			}
		}

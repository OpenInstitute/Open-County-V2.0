...
if($item <> '' or $gal <> '')
{
	...
	//displayArray($pic_list);
	
	$sshow_large = '';
	$sshow_thumb = '';
		  
	
	//if(@is_array(master::$listGallery['cont']) and array_key_exists($item,master::$listGallery['cont'])) {
	  //$pic_list        = master::$listGallery['cont'][$item]; 
...
<div class="slider bxflex" style="max-height:350px !important; overflow:hidden !important;">
